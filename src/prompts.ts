...
const defaultPrompts: PromptsCollection = {
  ...
  zh: [
    ...
    { act: '简洁定义', prompt: '{topic}' },
    {
      act: '纯文本',
      prompt:
        '"{topic}"。不要使用markdown、标题或任何特殊格式。只返回定义本身的文本。'
    },
  ...
  en: [
    // 默认提示模板
    {
      ...
      prompt:
        'Please provide a concise, encyclopedia-style definition for the term: "{topic}" in English. Please provide informative and neutral content. Do not use markdown, headings, or any special formatting. Return only the text of the definition itself.'
    },
    {
    ...
    },
    {
      ...
      prompt:
        'Please answer the question "{topic}" in English.\n\nContext information: {context}'
    },
